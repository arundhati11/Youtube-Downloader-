...
def Widgets(): 
    ...
    destination_label = Label(root,  
                              text="Give download destination here :", 
                              bg="#E8D579") 
...
def Browse(): 
    download_Directory = filedialog.askdirectory(initialdir="C://Users//Dona//Desktop//Advanced_Python_Netwerz") 
